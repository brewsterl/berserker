...
namespace Berserker
{
    public class ProtocolReceive
	{
        ...
        /// <returns></returns>
        public LoginInfo HandlePlayerLogin(Socket s)
		{
            netmsg.ReadFromSocket();
            netmsg.SkipBytes(5); //Client bytes, useless to us
			
            uint version = netmsg.GetU16(); //Client version [TODO: Check if client version is correct?] IMPORTANT!
        ...
        /// </summary>
        public void StartReceiving(GameWorld world, Player player)
		{
            CurrentWorld = world;
